describe('empty spec', () => {
  ...
  describe('First visit to homepage', () => {
    ...
    it('Should be able to make network requests to get movies', () => {
    ...
    it('Should be able to return error of bad network requests', () => {
      cy.intercept('GET', 'https://rancid-tomatillos.herokuapp.com/api/v2/movies/example', {
        error: {
          length: 108,
          name: "error",
          severity: "ERROR",
    ...
    it('Should be able to visit the home page and render the correct elements', () => {
        cy.contains('Bienvenidos a Tomatillos Rancios!')
    });
    ...
    it('Should render correct amount/length of movie cards', () => {
      cy.get('[class*=movie-card]').should('have.length', 40)
    })

    it('Should be able to see text of movie card', () => {
